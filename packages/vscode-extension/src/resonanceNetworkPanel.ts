...
export class ResonanceNetworkPanel {
  public static currentPanel: ResonanceNetworkPanel | undefined;
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    ResonanceNetworkPanel.currentPanel = new ResonanceNetworkPanel(
      panel,
      extensionUri
    );
  }
   ...
   */
  public updateGraph(data: { nodes: any[]; links: any[] }) {
    this._panel.webview.postMessage({
      type: "update",
      data,
    });
  ...
  private _getHtmlForWebview(webview: vscode.Webview): string {
    ...
    const styleUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "webview-ui", "resonance-network.css")
    );

    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "webview-ui", "resonance-network.js")
    );
