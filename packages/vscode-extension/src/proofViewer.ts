...
import type { CompositionResult } from './compositionEngine';

export class ProofViewerPanel {
	public static currentPanel: ProofViewerPanel | undefined;
	...
	public static createOrShow(
		...
		ProofViewerPanel.currentPanel = new ProofViewerPanel(
			panel,
			extensionUri,
			noosphereClient
		);
	 ...
	 */
	public showComposition(result: CompositionResult) {
