...
exports.NoospherePanel = void 0;
const vscode = __importStar(require("vscode"));
class NoospherePanel {
    static currentPanel;
    panel;
    extensionUri;
    noosphereClient;
     ...
     */
    static createOrShow(extensionUri, noosphereClient) {
        ...
        // Create new panel
        const panel = vscode.window.createWebviewPanel('lambdaNoosphere', '🌌 λ-Noosphere', column, {
            enableScripts: true,
            retainContextWhenHidden: true,
            localResourceRoots: [extensionUri]
        });
        NoospherePanel.currentPanel = new NoospherePanel(panel, extensionUri, noosphereClient);
    }
    /**
     ...
     */
    async exploreMorphism(morphismName) {
...
${morphism.properties.map(p => `- ${p}`).join('\n')}
		`.trim();
        const action = await vscode.window.showInformationMessage(message, 'Open Proof', 'Insert Example');
     ...
     */
    async insertMorphismExample(morphismName) {
...
exports.NoospherePanel = NoospherePanel;
//# sourceMappingURL=noospherePanel.js.map